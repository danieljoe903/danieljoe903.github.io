...
async function handleSubmit(e) {
  ...
  const projects = [
    ...
    {
      title: "FastAPI Property API",
      desc: "A high-performance REST API built with FastAPI for handling property data, user interactions, and scalable backend operations with modern async support.",
      status: "Upcoming",
